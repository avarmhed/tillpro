...
# Skapar en class för ett event (kalenderhändelse)
class event:
    def __init__(self):
        self.string1 = ''
        self.string2 = ''
...
## parse_url_file
##
## IN (file_content) string expected
##
## OUT vector/list of a schedule
##
## html -> list of events with info
...
## OUT: string
##
## takes the name of the file to open. Opens it, reads it and outputs the html as a string
...
## IN nothing
##
## OUT nothing, but prints stuff in the terminal
##
def usage():
    print ("Usage example:")
    print ("python", sys.argv[0], "--update ")
...
##
## looks for input arguments ex. --check or --help
##
## IN nothing
##
## OUT a string with information of what argument was put in
##
...
## IN list
##
## OUT print of the list (schedule)
##
...
## search_data
##
## IN string, format ex "v 49"
##
## OUT events or "Nothing happens"
##
...
## Buggrapport (v9)
# 1. Första eventet har inget datum
# 2. Andra och tredje eventet har fel datum
# 3. Sista eventet finns inte med
#
#
#
#
